...
namespace Completed
{
    ...
    public class Player : MovingObject
    {
        ...
        [SerializeField, Tooltip("Poisonオブジェクトに触れた時に減るfoodの量")]
        private int pointsPerPoisonLess = 10;
        ...
        private void OnTriggerEnter2D(Collider2D other)
        {
            ...
            {
                food -= pointsPerPoisonLess;
                foodText.text = "-" + pointsPerPoisonLess + " Food: " + food;
                other.gameObject.SetActive(false);
            }
        }
